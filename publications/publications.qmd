...
This page lists all papers published by Dr. Kevin Bladon, organized by year of publication. Click a paper’s *title* to visit the publisher page and access the official version. Use *Abstract* to reveal the summary, *Citation* for the APA 7th-edition reference, and *BibTeX* to view the BibTeX entry. Clicking the link a second time will close the display again. *Article* links to a free version of the publication, and *Materials* leads to an open repository with data, code, and other open-science resources. <span style="font-size:0.9rem; opacity:0.8; margin-bottom:0.5rem;">★ = Work led or co-led by our lab</span>
...
bib  <- ReadBib("publications_new.bib", check = FALSE)
keys <- names(bib)
